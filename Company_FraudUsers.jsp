...
<title>Normal and Fraud Users</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						<h2 class="title"><a href="#"><span class="style6" style="color:#009966"><%=(String)application.getAttribute("tname")%></span> Travels Noraml and Fraud Users..</a></h2>
						<div class="entry">
						<p>
	  	      <%
	String tname=(String)application.getAttribute("tname");		  
	String s1="",s2="",s3="",s4="",s5="",s6="",s7="",activity="";
	int count=0;
	try
	{
			String sql3="select distinct activity from financial_fraud where transport='"+tname+"'";
			Statement st3=connection.createStatement();
			  ResultSet rs3=st3.executeQuery(sql3);
			while ( rs3.next() )
			   {
			   activity=rs3.getString(1);
			...
			%>
	  	    ...
	  	    <table width="572" border="1">
				  ...
				  <td colspan="8" > 
				       	<%
						if(activity.equalsIgnoreCase("normal"))
						{
						
						%>
             <div align="left" class="style9">
                  <strong><%out.println(activity);%></strong> <strong>Users </strong>
              </div>
             ...
             <div align="left" class="style12">
			  ...
			  <td  width="123" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style5"><strong>Date</strong></div></td>
				  ...
				  <%
						   	...
						   	String query="select * from financial_fraud where activity='"+activity+"' and transport='"+tname+"'"; 
