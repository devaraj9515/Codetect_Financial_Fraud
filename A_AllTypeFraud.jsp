...
<title>All Type of Fraud Details</title>
...
<div id="wrapper">
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						<h2 class="title"><a href="#">All Types of Fraud Details..</a></h2>
						<div class="entry">
						<p>
	  	      <%
	...
	try
	{
			String sql3="select distinct fraud_type from financial_fraud where fraud_type!='"+"normal"+"'";
             ...
             <div align="left" class="style12">
			  ...
			  <td  width="123" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style5"><strong>Date</strong></div></td>
				  ...
				  <%
						   	...
						   	String query="select * from financial_fraud where fraud_type='"+fraud+"'"; 
