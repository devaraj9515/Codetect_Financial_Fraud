...
<%
  	...
  	try{  
		...
		else if(pic.equals("transportimage"))
		 {
				Statement st=connection.createStatement();
				String strQuery = "select t_image from transport where id="+id+"" ;
				ResultSet rs = st.executeQuery(strQuery);
				String imgLen="";
				if(rs.next())
				{
		 ...
		 {
				Statement st=connection.createStatement();
				String strQuery = "select p_image from products where p_name='"+p_Name+"'" ;
				ResultSet rs = st.executeQuery(strQuery);
				String imgLen="";
				if(rs.next())
				{
