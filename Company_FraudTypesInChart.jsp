			...
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						...
						<iframe width="550" height="400" src="Company_FraudTypesInChart1.jsp"></iframe>
			  				<br/>
			  				<span class="style3">(All Frauds For Wrong CVV)							</span>
			  				<p>&nbsp;</p>
							
						
			  <iframe width="550" height="400" src="Company_FraudTypesInChart2.jsp"></iframe>
			  				<br/>
			  				<span class="style3">(All Credit Card Users For No Balance)</span>
		  <p>&nbsp;</p>
		<div align="left" class="style22"><a href="CompanyUserMain.jsp" class="style11">Back</a></div>
