	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						<h2 class="title"><a href="#">User <span class="style6" style="color:#FF3300"><%=request.getParameter("user")%></span>'s Booked Ticket Details..</a></h2>
						<div class="entry">
						<p>&nbsp;</p>
			...
			%>
			  ...
			  <td  width="139"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56"><strong>Booked Date</strong></div></td>
				  ...
				  <%
						   	...
						   	String query="select * from booking where user='"+user+"' and date='"+date+"'"; 
