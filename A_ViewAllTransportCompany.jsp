...
<title>Transport Details Page</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						<h2 class="title"><a href="#">All Transport Company Details..</a></h2>
						<div class="entry">
						<p><iframe width="550" height="600" src="A_ViewTransports.jsp"></iframe></p>
