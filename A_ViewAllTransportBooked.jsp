...
<title>All Transport Booked</title>
...
<div id="wrapper">
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						<h2 class="title"><a href="#">All Transport Company Booked Ticket Details..</a></h2>
						<div class="entry">
						<p>&nbsp;</p>
          <p>
	  	      <%
	...
	try
	{
			String sql3="select distinct transport from booking";
			...
			%>
	  	    ...
	  	    <table width="572" border="1">
				  <tr bgcolor="#FFFFFF">
				  <td colspan="8" ><class="style6" style="color:#336600" ><span class="style6"></span> 
				       	<%
             ...
             <div align="left" class="style15">
              ...
              <td  width="139"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56"><strong>Booked User</strong></div></td>      
			  ...
			  <td  width="139"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56"><strong>Booked Date</strong></div></td>
				  ...
				  <%
						   	...
						   	String query="select * from booking where transport='"+tname+"'"; 
