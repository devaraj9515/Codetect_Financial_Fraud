			...
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						...
						<div class="entry">
						<form action="C_FixTravelPrice1.jsp" method="post">
			                        <%
									try{
                    ...
                    <table width="500" border="0" align="center">
					  ...
					  <tr>
                        <td height="40"><div align="justify"><span class="style3 style8 style38">From</span></div></td>
					  <td width="253"><select id="s2" name="from" style="width:150px;" class="text">
					  ...
					  <tr>
                        <td height="40"><div align="justify"><span class="style3 style8 style38">To</span></div></td>
					  <td width="253"><select id="s2" name="to" style="width:150px;" class="text">
                        <option>--Select--</option>
                        <option>Bengaluru</option>
                        <option>Mysore</option>
						<option>Mangaluru</option>
					  ...
					  <tr>
                        <td height="40"><div align="justify"><span class="style3 style8 style38">Price </span></div></td>
                        <td><label>
