	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post">
						<h2 class="title"><a href="#"><span class="style6" style="color:#009966"><%=request.getParameter("tname")%></span> Transport Details..</a></h2>
						<div class="entry">
						<p>&nbsp;</p>
          <table width="560" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr>
			  ...
			  <td  width="133" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style5"><strong></strong></div></td>
            ...
            <tr>
			  ...
			  <form action="U_BookTicket.jsp" method="post">
			  <input name="tname" type="hidden" value="<%=s1%>" readonly="" />
          ...
          <p align="right"><a href="U_ViewTransportCompany.jsp" class="style11"></a></p>
